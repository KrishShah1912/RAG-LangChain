...
if prompt := st.chat_input("Ask me anything..."):
    ...
    with st.chat_message("assistant"):
        with st.spinner("Agent searching & thinking..."):
            ...
            # Use version="v2" for the most stable output format in 2026
            for event in app.stream(input_data, config=config, stream_mode="values", version="v2"):
                # In 'values' mode, 'event' is the full state. 
                # We want the content of the LAST message generated by the assistant.
            ...
            if final_answer:
                ...
                st.error("The agent could not generate an answer. Check your Graph nodes.")